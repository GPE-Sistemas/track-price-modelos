...
exports.SConsultor = void 0;
const mongoose_1 = require("mongoose");
exports.SConsultor = new mongoose_1.Schema({
    // Usuario
    activo: { type: Boolean },
...
exports.SConsultor.virtual('zonas', {
    foreignField: '_id',
    justOne: false,
    localField: 'idsZona',
    ref: 'zonas',
});
exports.SConsultor.virtual('regiones', {
    foreignField: '_id',
    justOne: false,
    localField: 'idsRegion',
    ref: 'regiones',
});
exports.SConsultor.virtual('provincias', {
    foreignField: '_id',
    justOne: false,
    localField: 'idsProvincia',
    ref: 'provincias',
});
exports.SConsultor.virtual('departamentos', {
    foreignField: '_id',
    justOne: false,
    localField: 'idsDepartamento',
    ref: 'departamentos',
});
exports.SConsultor.virtual('localidades', {
    foreignField: '_id',
    justOne: false,

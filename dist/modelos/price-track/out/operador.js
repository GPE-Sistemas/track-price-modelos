...
exports.IOperadorDTOSwagger = exports.IOperadorDTOValidation = void 0;
...
exports.IOperadorDTOValidation = joi_1.default.object({
    // Usuario
    ...
    rol: joi_1.default.string().allow('consultor', 'relevador'),
    // Operador

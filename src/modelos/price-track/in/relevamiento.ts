...
export const IRelevamientoValidation = joi.object<IRelevamiento>({
    ...
    condicionComercial: joi.string().allow('', null), // .allow('Distribuidor', 'Grandes Cuentas', 'Productor'),
    fuente: joi.string().allow('', null),
    tipoRelevamiento: joi.string().allow('', null), // .allow('Condición de Mercado', 'Precio de Lista', 'Cotización Perdida', 'Disponibilidad'),
    verificado: joi.boolean(),
    observaciones: joi.string().allow('', null),
    disponibilidad: joi.string().allow('', null), // .allow('Reduccion de disponibilidad para comprar', 'Demora en entrega, pero entregan', 'Reducción de volumen a entregar de lo que ya estaba comprado', 'No entrega de lo pactado'),

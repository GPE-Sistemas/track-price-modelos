...
export const SConsultor = new Schema<IConsultorDb>({
    // Usuario
    activo: { type: Boolean },
...
SConsultor.virtual('departamentos', {
    foreignField: '_id',
    justOne: false,
...
SConsultor.virtual('localidades', {
    foreignField: '_id',
    justOne: false,
